// FILE: src/pages/apply/ApplyFormFields.tsx
// The input block for the apply form. Single-column, mobile-first (C10). Owns no
// submit logic — the parent (Form.tsx) holds state and passes handlers. Resume
// uses the native file-input pattern (C7); the honeypot is visually offscreen but
// present in the DOM (R4).
