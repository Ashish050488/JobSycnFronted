// FILE: src/pages/seeker/Profile.tsx
...
import { Container, Card, Button, Alert, PageHeader, Stack, SkeletonCard, EmptyState } from '../../components/ui';
    ...
    return (
      <Container size="md" style={{ paddingTop: 32, paddingBottom: 60 }}>
        ...
        <EmptyState
          ...
          action={<Link to="/resume"><Button variant="primary">Upload your resume</Button></Link>}
        />
      </Container>
    );
  }
